...
class PlanningRepository extends ServiceEntityRepository
{
    ...
    public function getPlaningOfCoach($coachId)
    {
        return $this->createQueryBuilder('p')
            ->where('p.idCoach = :coachId')
            ->setParameter('coachId', $coachId)
            ->getQuery()
            ->getResult();
    }

    public function getPlaningOfGamer($GamerId)
    {
        return $this->createQueryBuilder('p')
            ->where('p.idGamer = :idGamer')
            ->setParameter('idGamer', $GamerId)
            ->getQuery()
            ->getResult();
    }
